...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-a5r7!je@8vp3!vu*0_@&n#j+y2iy_s2xg77u8!9u8*^=wlq9s$')
...
DATABASES = {
    'default': {
        'ENGINE': config('DB_ENGINE', default='django.db.backends.mysql'),  # ✅ Fixed: was 'Db_ENGINE'
        'NAME': config('DB_NAME', default='poll'),
